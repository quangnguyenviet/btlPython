...
class Order(models.Model):
    ...
    orderStatus = models.CharField(max_length=10, choices=statusChoices, default='Pending')  # Trạng thái đơn hàng
    ...
    # def __str__(self):
    #     return f"Order {self.orderID} by {self.userID.user.username}"